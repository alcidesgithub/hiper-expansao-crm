          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-primary/50 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                Acesse condições comerciais exclusivas. Negociações em bloco e transferências com as principais indústrias e distribuidoras garantem sua competitividade.
              </p>
            </div>
